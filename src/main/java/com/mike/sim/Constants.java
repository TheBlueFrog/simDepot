...
//    }
    ...
    public static final int TransporterSleepTime = 500;
     ...
     */
    public static double kgPerPig = 200.0;
    public static double kgPerBeef = 700.0;
    public static double kgPerLamb = 65.0;
